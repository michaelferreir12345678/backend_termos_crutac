...
def gerar_pdf_dados_aluno(dados):
    # Definir buffer para o PDF
    pdf_buffer = io.BytesIO()
    c = canvas.Canvas(pdf_buffer, pagesize=A4)  # Definindo o Canvas com o buffer em vez de um nome de arquivo
    largura, altura = A4
    ...
    # Volta o buffer para o início para ser lido
    pdf_buffer.seek(0)
    return pdf_buffer
